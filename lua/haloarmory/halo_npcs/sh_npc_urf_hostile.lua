HALOARMORY.MsgC("Shared HALOARMORY URF [Hostile] NPCs loaded!")

local function AddNPC( t, class )
    list.Set( "NPC", class or t.Class, t )
end

local Category = "HALOARMORY - URF [Hostile]"
...
local BaseNPC_Class = "npc_combine_s"
...
}, "npc_haloarmory_unsc_marine_hostile" )