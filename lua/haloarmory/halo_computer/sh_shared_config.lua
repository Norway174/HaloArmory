...
HALOARMORY.COMPUTER.EMAIL.ACTION_CONTACT_DIRECTORY = "contact_directory"
HALOARMORY.COMPUTER.EMAIL.ACTION_SAVE_CONTACT_SET = "save_contact_set"
HALOARMORY.COMPUTER.EMAIL.ACTION_DELETE_CONTACT_SET = "delete_contact_set"

HALOARMORY.COMPUTER.EMAIL.CAMI_CONTACT_SET_PERMISSION = "HALOARMORY.Email Contact Sets"
...
if SERVER then
    ...
    HALOARMORY.COMPUTER.EMAIL.SERVER_CONTACT_SETS_FILE = HALOARMORY.COMPUTER.Directory .. "email_contact_sets.json"
    ...
    HALOARMORY.COMPUTER.EMAIL.CLIENT_ALIASES_FILE = HALOARMORY.COMPUTER.EMAIL.CLIENT_STORAGE_DIR .. "aliases.json"
    HALOARMORY.COMPUTER.EMAIL.CLIENT_CONTACT_LISTS_FILE = HALOARMORY.COMPUTER.EMAIL.CLIENT_STORAGE_DIR .. "contact_lists.json"
